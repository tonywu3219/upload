...
set rtlPath "/home/linux/ieng6/ee260bwi25/public/DESIGNdata/aes_cipher_top/rtl"
set libPath "/home/linux/ieng6/ee260bwi25/public/PDKdata"

# Target library
set target_library "$libPath/db/tcbn65gplustc.db" 
...
create_mw_lib -tech "$libPath/techfiles/tsmcn65_8lmT2.tf" -bus_naming_style {[%d]} -mw_reference_library "$libPath/techfiles/tcbn65gplus" mwlib

open_mw_lib mwlib


set_tlu_plus_files \
-max_tluplus "$libPath/techfiles/cln65g+_1p08m+alrdl_top2_cworst.tluplus" \
-min_tluplus "$libPath/techfiles/cln65g+_1p08m+alrdl_top2_cworst.tluplus" \
-tech2itf_map "$libPath/techfiles/star.map_8M"
...
compile_ultra -no_autoungroup -timing_high_effort_script -exact_map -spg
